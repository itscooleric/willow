...
function writeArrayToMemory(array, buffer) {
    try {
        ...
        console.error(err);
        console.log(`HEAP8 is ${HEAP8.length} & ${HEAP8.byteLength} need ${array.length + buffer}`)
        // let theap8 = new Uint8Array(new ArrayBuffer(array.length + buffer))
        // theap8.set(HEAP8);
        // theap8.set(array, buffer);
        // HEAP8 = theap8;
        debugger;
        // console.log('I think it is fixed now')
    }
}
...
function integrateWasmJS() {
    ...
    var wasmTextFile = Module["wasmTextFile"] || "xgboost.wast";
    var wasmBinaryFile = Module["wasmBinaryFile"] || "xgboost.wasm";
    var asmjsCodeFile = Module["asmjsCodeFile"] || "xgboost.temp.asm.js";
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "xgboost.js.mem" : null;
var STATIC_BUMP = 84208;
